...
hero:
  caption:
    ...
    subheading: MDX is an extension of markdown (.md), so you can still write your pages in plain markdown, mixed in with regular HTML with Taiwind CSS or custom CSS classes. Now you can also write JSX and use React components in your markdown files - just use the .mdx file extension.
title: About
---
