...
export const Box: FC<BoxProps> = ({
  ...
  <Element
    ...
    className={classNames(
      ...
      flex && `flex flex-${flex}`,
      {
        "flex-col flex-nowrap": flow === "col-nowrap",
        "flex-col-reverse flex-nowrap": flow === "col-reverse-nowrap",
        ...
        "flex-row flex-nowrap": flow === "row-nowrap",
        "flex-row-reverse flex-nowrap": flow === "row-reverse-nowrap",
